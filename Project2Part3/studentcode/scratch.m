...
matlabFunction(simplify(J),'vars',{x,w_m,a_m,n},'file','ekf2jacobian');
matlabFunction(simplify(Jnoise),'vars',{x},'file','ekf2noisejacobian');
...
R = @(q) [cos(q(3))*cos(q(2)) - sin(q(1))*sin(q(3))*sin(q(2)), ...
     cos(q(2))*sin(q(3)) + cos(q(3))*sin(q(1))*sin(q(2)), ...
     -cos(q(1))*sin(q(2)); ...
     -cos(q(1))*sin(q(3)),...
     cos(q(1))*cos(q(3)), ...
     ...
     sin(q(3))*sin(q(2)) - cos(q(3))*cos(q(2))*sin(q(1)),...
     cos(q(1))*cos(q(2))];
disp(simplify(R(q)*transpose(R(q)) == eye(3)))

...
load('/home/stephen/Dropbox/Documents/PhD/Classes/MEAM620/Project2Part2/proj2_phase2_student_code/data/studentdata1.mat')


estimate_vel(data(1),K,tagsX,tagsY);
estimate_vel(data(2),K,tagsX,tagsY);
